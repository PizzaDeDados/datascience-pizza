...
# J
**Julia**:  Julia é uma linguagem de programação de alto nível, dinâmica e de alto desempenho para computação científica, com uma sintaxe fácil de escrever, similar ao Python. Ela fornece um compilador sofisticado, execução paralela distribuída, precisão numérica e uma extensa biblioteca de funções matemáticas e estatísticas.[Referência](http://www.cienciaedados.com/julia-a-princesinha-do-cientista-de-dados/), [Oficial Docs](https://docs.julialang.org/en/v1/)
